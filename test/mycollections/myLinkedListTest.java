...
public class myLinkedListTest {
    ...
    public void testToArrayWhenInputArrayHaveCorrectSize() throws Exception {
        ...
        final Integer[] input = new Integer[]{4,5,6};
...
//try {
//    final Integer previous1 =listIterator.previous();//сам себя проверил
// на правильность работы previous
//    fail("previos method has been called for 2 times");
